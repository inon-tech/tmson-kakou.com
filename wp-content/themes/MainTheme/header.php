    ...
    <div class="l-headerSP">
      ...
      <div class="l-headerSP__content js-headerSP__content">
        <ul>
          ...
          <li><a class="bold" href="<?php echo esc_url(home_url('facility')); ?>">主要設備紹介</a></li>
          <li><a class="bold" href="<?php echo esc_url(home_url('news')); ?>">お知らせ</a></li>
          <li><a class="bold" href="<?php echo esc_url(home_url('recruit')); ?>">採用情報</a></li>
