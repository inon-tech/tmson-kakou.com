...
<main class="p-strength">
  <section class="p-companyFV l-page-FV">
    <h1 class="l-page-FV__title">
      <img src="<?php echo esc_url(get_template_directory_uri()) . $IHY_img_1 ?>strength/strength-title.png" alt="">
      <img src="<?php echo esc_url(get_template_directory_uri()) . $IHY_img_1 ?>strength/strength-title-sp.png" alt="">
    </h1>
  ...
  <section class="p-strengthContent">
  ...
  <section class="p-strengthColumn">
